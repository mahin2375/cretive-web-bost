...
//#region src/routes/_authenticated/admin.memberships.tsx?tsr-split=component
function AdminMembershipsPage() {
	return /* @__PURE__ */ jsx(AdminPage, {
		title: "Membership Plans",
		description: "Silver, Gold, Platinum verified plans.",
		children: /* @__PURE__ */ jsx(CrudPanel, {
			...
			fields: [
				...
				},
				{
					...
					label: "Benefits",
					type: "tags",
					placeholder: "Comma separated benefit list"
				},
				{
...
//#endregion
export { AdminMembershipsPage as component };
